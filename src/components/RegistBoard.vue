            ...
            registboard() {
                ...
                if (!this.editMode) {
                    axios
                        ...
                        .post('http://43.200.96.196:8888/board/regist-board.do', this.setParams) //Spring Boot
                        .then((response) => {
                ...
                // 글 수정 호출
                    ...
                    axios
                        ...
                        .post('http://43.200.96.196:8888/board/edit-board.do', this.setParams) //Spring Boot
                        .then((response) => {
                            if (response.data.success || response.data.result) {
                                // 창의 화면 변수 false로 창 닫기
                                this.openPopup = false;
